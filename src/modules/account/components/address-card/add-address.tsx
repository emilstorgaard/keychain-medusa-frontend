...
const AddAddress = ({ region }: { region: Region }) => {
  ...
  return (
    <>
      ...
      >
        <span className="text-base-semi">Ny adresse</span>
        <Plus />
      </button>

      <Modal isOpen={state} close={close} data-testid="add-address-modal">
        <Modal.Title>
          <Heading className="mb-2">Tilføj adresse</Heading>
        </Modal.Title>
        <form action={formAction}>
          <Modal.Body>
            <div className="flex flex-col gap-y-2">
              ...
              />
              <Input label="Mobil" name="phone" autoComplete="phone" data-testid="phone-input" />
            </div>
            {formState.error && (
