              ...
              <div className="flex flex-col w-1/3">
                ...
                {process.env.NODE_ENV === "development" &&
                  !Object.hasOwn(
                    ...
                    <Tooltip content="Du kan tilføje et brugervenligt navn og ikon til denne betalingsudbyder i 'src/modules/checkout/components/payment/index.tsx'." />
                  )}
              </div>
              <div className="flex flex-col w-1/3">
                <Text className="txt-medium-plus text-ui-fg-base mb-1">
